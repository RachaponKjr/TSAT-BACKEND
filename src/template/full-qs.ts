  ...
  <div class="container">
    ...
    <div class="main-content">
      <div class="customer-section">
        <h5>รายละเอียดการเช็คสภาพ</h5>
        <div class="meta-grid">
          <div class="label-item">
            <span class="label-title">ลูกค้า:</span>
            <span class="label-value">${data?.customer_name}</span>
          </div>
          <div class="label-item">
            <span class="label-title">รุ่นรถ:</span>
            <span class="label-value">${data?.car_model_name}</span>
          </div>
          <div class="label-item">
            <span class="label-title">ทะเบียน:</span>
            <span class="label-value">${data?.plate}</span>
          </div>
          <div class="label-item">
            <span class="label-title">เลขกิโลเมตร:</span>
            <span class="label-value">${data?.car_mileage} กม.</span>
          </div>
        </div>
      </div>
          ...
          <td class="text-center text-gray">
            ${
              item.criteria.length > 1
                ? `${category.sequence}.${item.sequence}.${criteria.sequence}`
              ...
              <td>
                <div class="result-container">
                  <span class="circle circle-pass ${
                    criteria.result === 'OK' ? 'active' : ''
                  }"></span>
                  <span class="circle circle-fail ${
                    criteria.result === 'FAIL' ? 'active' : ''
                  }"></span>
                </div>
              </td>
