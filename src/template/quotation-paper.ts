      ...
      <div class="flex justify-between items-center mb-0">
        ...
        <div class="flex flex-row gap-12">
          ...
          <div class="flex flex-col">
            ...
            <span class="text-[#333333] text-base">${data?.quotationId}</span>
          </div>
          <!-- วันที่ (disabled) -->
          <div class="flex flex-col">
            <label class="text-sm text-[#666666]">วันที่</label>
            <span class="text-[#333333] text-base">${dayjs(
              data?.createdAt
      ...
      <div class="flex-1 mt-4">
        <div class="flex flex-row gap-2">
            ...
            <div class="p-2 xl:p-4 flex flex-col gap-0">
              ...
              <div class="flex flex-row items-center justify-between">
                ...
                <div class="flex flex-1 items-baseline gap-3">
                  <span class="text-[50px] xl:text-[80px] leading-none font-bold text-[#1CA44D]">${getGradeColor(
          ...
          <div class="border border-[#DDDDDD]  flex-1 rounded-lg bg-white flex flex-col gap-0">
            <img
              class="bg-gray-100 w-full aspect-video object-cover relative overflow-hidden flex items-center justify-center text-[#AAAAAA] text-sm"
            ...
            <div class="w-full h-full flex flex-col gap-4 text-[#333333]">
              <div class="flex items-center justify-between gap-2">
                ...
                <span id="ref-avg-0" class="font-semibold text-xs xl:text-base text-nowrap">
                  ราคาเฉลี่ย : ${calculateSingleAveragePrice({
            ...
            <table class="w-full text-sm xl:text-base border-collapse">
              ...
              ${data.items
                ...
                <tr class="even:bg-[#F5F5F5]">
                  <td class="px-3 py-2 text-[#666666]">${index + 1}</td>
                  <td class="px-3 py-2 text-[#333333]">${item.item_name}</td>
                  <td class="px-3 py-2 text-right text-[#333333]">${
                    item.quantity
                  }</td>
                  <td class="px-3 py-2 text-right text-[#333333]">${
                    item.total_price
          ...
          <div class="flex justify-end">
            <div class="w-full sm:w-[320px] border border-[#DDDDDD] overflow-hidden text-sm xl:text-base">
              <div class="flex justify-between items-center px-4 py-2">
                ...
                <span class="font-bold text-[#333333]">${totalPrice} บาท</span>
              </div>
              <div class="flex justify-between items-center px-4 py-2 bg-[#F5F5F5]">
                <span class="text-[#333333]">VAT 7%</span>
                <span class="font-bold text-[#333333]">${vat} บาท</span>
              </div>
              <div class="flex justify-between items-center px-4 py-2 bg-[#F5F5F5] border-t border-[#DDDDDD]">
                ...
                <span class="font-bold text-[#333333]">${totalWithVat} บาท</span>
              </div>
            </div>
          </div>
        </div>
