        ...
        <div style="display: flex; flex-direction: row; gap: 16px;">
          ...
          <div style="border: 1px solid #DDDDDD; flex: 1; border-radius: 8px; background-color: #ffffff; display: flex; flex-direction: column; gap: 0;">
            <img
              ...
              alt=""
            />
            <div style="color: #333333; display: flex; flex-direction: column; gap: 8px; justify-content: space-between; height: max-content; padding: 12px 16px;">
            ...
            <div style="width: 100%; height: 100%; display: flex; flex-direction: column; gap: 16px; color: #333333;">
              <div style="display: flex; align-items: center; justify-content: space-between; gap: 8px;">
                <div style="display: flex; gap: 8px; align-items: center; flex: 1;">
                  <!-- Logo Uploader (small) -->
                  <img
                  style="width: 56px; height: 56px; object-fit: cover; flex-shrink: 0; border-radius: 6px; display: flex; align-items: center; justify-content: center;"
