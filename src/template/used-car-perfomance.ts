...
<body>
  ...
  <div style="border: 1px solid #ccc; border-radius: 6px; padding: 20px; font-family: sans-serif; color: #333; margin-bottom: 0px; font-size: 12px; line-height: 1.4;">
  ...
  />
      ...
      <div style="display:flex;flex-direction: column; gap:12px;flex-basis:18rem;flex-shrink:0">
          <div style="border: 1px solid #ccc; border-radius: 6px; padding: 12px;display:flex;flex-direction: column; gap:12px;">
              <img src="data:image/webp;base64," alt="" width="100" height="24" />
          <div style="display:flex;flex-direction: column;color:#666666;">
              <span style="font-size:14px">ผลการประเมิน</span>
              <span style="font-size:17px;font-weight: bold">${getGradeLabelUsedCar(
                data?.overallGrade
              )}</span>
          </div>
  ...
  <div style="display:flex; flex-direction: column;">
    <span style="font-size:14px; color:#666666; margin-bottom: 2px;">Overall Grade</span>
  ...
  <!-- กล่องคะแนนรวม -->
          <div style="display:flex; flex-direction: column;">
            <span style="font-size:14px; color:#666666; margin-bottom: 2px;">คะแนนรวม</span>
            <span style="color:${getGradeColor(
              data?.overallGrade
          ...
          <div style="display:flex;flex-direction: column;font-size:12px;color:#999999;gap:2px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px 24px; margin-bottom: 24px;">
        ${data.categoryResults
          .map((cat, index) => {
            ...
            <!-- หัวข้อหมวดหมู่ -->
            <div style="display:flex;flex-direction: column;">
              <div style="font-size: 14px; color: #222222; font-weight: bold; line-height: 1.2;">
                ${cat.categoryName}
              </div>
              ...
              <!-- สรุปรายการ (Badges) -->
              <div style="display: flex; align-items: center; gap: 8px; font-size: 13px; color: #666666; margin-top: 4px;">
  ...
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px;">
    ...
    ${item.itemResults
      ...
      <div style="display: flex; gap: 8px;margin-bottom:8px">
        <!-- Placeholder Image -->
       <div style="width: 130px; height: 80px; background-color: #ddd; border-radius: 6px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
        <img 
          src="${base64Image}" 
          alt="" 
          style="width: 100%; height: 100%; object-fit: cover; display: block;" 
